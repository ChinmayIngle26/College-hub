...
# If you are using Firebase Admin SDK for server-side operations (like in src/lib/firebase/admin.server.ts),
...
*   **Firestore:** As a NoSQL database to store user profiles and system settings.
...
*   **"Missing or insufficient permissions" (Firestore Error)**:
    ...
    *   **4. Verify User Authentication & Student ID**: Ensure the user is signed in.
